...
type LocalVolumeInterface interface {
	Create(*extensions.LocalVolume) (*extensions.LocalVolume, error)
	Update(*extensions.LocalVolume) (*extensions.LocalVolume, error)
	UpdateStatus(*extensions.LocalVolume) (*extensions.LocalVolume, error)
...
func (c *localVolumes) UpdateStatus(localVolume *extensions.LocalVolume) (result *extensions.LocalVolume, err error) {
	result = &extensions.LocalVolume{}
	err = c.client.Put().
		Resource("localvolumes").
		Name(localVolume.Name).
