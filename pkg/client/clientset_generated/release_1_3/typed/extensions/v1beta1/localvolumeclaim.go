...
type LocalVolumeClaimInterface interface {
	Create(*v1beta1.LocalVolumeClaim) (*v1beta1.LocalVolumeClaim, error)
	Update(*v1beta1.LocalVolumeClaim) (*v1beta1.LocalVolumeClaim, error)
	UpdateStatus(*v1beta1.LocalVolumeClaim) (*v1beta1.LocalVolumeClaim, error)
	Delete(name string, options *api.DeleteOptions) error
	DeleteCollection(options *api.DeleteOptions, listOptions api.ListOptions) error
	Get(name string) (*v1beta1.LocalVolumeClaim, error)
	List(opts api.ListOptions) (*v1beta1.LocalVolumeClaimList, error)
...
func (c *localVolumeClaims) Create(localVolumeClaim *v1beta1.LocalVolumeClaim) (result *v1beta1.LocalVolumeClaim, err error) {
	result = &v1beta1.LocalVolumeClaim{}
	err = c.client.Post().
		Namespace(c.ns).
...
func (c *localVolumeClaims) Update(localVolumeClaim *v1beta1.LocalVolumeClaim) (result *v1beta1.LocalVolumeClaim, err error) {
	result = &v1beta1.LocalVolumeClaim{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("localvolumeclaims").
...
func (c *localVolumeClaims) UpdateStatus(localVolumeClaim *v1beta1.LocalVolumeClaim) (result *v1beta1.LocalVolumeClaim, err error) {
	result = &v1beta1.LocalVolumeClaim{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("localvolumeclaims").
...
func (c *localVolumeClaims) Get(name string) (result *v1beta1.LocalVolumeClaim, err error) {
	result = &v1beta1.LocalVolumeClaim{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("localvolumeclaims").
...
func (c *localVolumeClaims) List(opts api.ListOptions) (result *v1beta1.LocalVolumeClaimList, err error) {
	result = &v1beta1.LocalVolumeClaimList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("localvolumeclaims").
