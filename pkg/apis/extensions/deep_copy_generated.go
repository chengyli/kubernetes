...
func init() {
	if err := api.Scheme.AddGeneratedDeepCopyFuncs(
		...
		DeepCopy_extensions_LocalVolume,
		DeepCopy_extensions_LocalVolumeClaim,
		DeepCopy_extensions_LocalVolumeClaimList,
		DeepCopy_extensions_LocalVolumeClaimSpec,
		DeepCopy_extensions_LocalVolumeClaimStatus,
		DeepCopy_extensions_LocalVolumeList,
		DeepCopy_extensions_LocalVolumeSource,
		DeepCopy_extensions_LocalVolumeSpec,
		DeepCopy_extensions_LocalVolumeStatus,
...
func DeepCopy_extensions_LocalVolume(in LocalVolume, out *LocalVolume, c *conversion.Cloner) error {
	if err := unversioned.DeepCopy_unversioned_TypeMeta(in.TypeMeta, &out.TypeMeta, c); err != nil {
		return err
	}
	if err := api.DeepCopy_api_ObjectMeta(in.ObjectMeta, &out.ObjectMeta, c); err != nil {
	...
	if err := DeepCopy_extensions_LocalVolumeSpec(in.Spec, &out.Spec, c); err != nil {
		return err
	}
	if err := DeepCopy_extensions_LocalVolumeStatus(in.Status, &out.Status, c); err != nil {
		return err
	}
	return nil
}

func DeepCopy_extensions_LocalVolumeClaim(in LocalVolumeClaim, out *LocalVolumeClaim, c *conversion.Cloner) error {
	if err := unversioned.DeepCopy_unversioned_TypeMeta(in.TypeMeta, &out.TypeMeta, c); err != nil {
		return err
	}
	if err := api.DeepCopy_api_ObjectMeta(in.ObjectMeta, &out.ObjectMeta, c); err != nil {
	...
	if err := DeepCopy_extensions_LocalVolumeClaimSpec(in.Spec, &out.Spec, c); err != nil {
		return err
	}
	if err := DeepCopy_extensions_LocalVolumeClaimStatus(in.Status, &out.Status, c); err != nil {
		return err
	}
	return nil
}

func DeepCopy_extensions_LocalVolumeClaimList(in LocalVolumeClaimList, out *LocalVolumeClaimList, c *conversion.Cloner) error {
	if err := unversioned.DeepCopy_unversioned_TypeMeta(in.TypeMeta, &out.TypeMeta, c); err != nil {
		return err
	}
	if err := unversioned.DeepCopy_unversioned_ListMeta(in.ListMeta, &out.ListMeta, c); err != nil {
	...
	if in.Items != nil {
		...
		*out = make([]LocalVolumeClaim, len(in))
		for i := range in {
			if err := DeepCopy_extensions_LocalVolumeClaim(in[i], &(*out)[i], c); err != nil {
				return err
			}
		}
	} else {
...
func DeepCopy_extensions_LocalVolumeClaimSpec(in LocalVolumeClaimSpec, out *LocalVolumeClaimSpec, c *conversion.Cloner) error {
...
func DeepCopy_extensions_LocalVolumeClaimStatus(in LocalVolumeClaimStatus, out *LocalVolumeClaimStatus, c *conversion.Cloner) error {
	out.Phase = in.Phase
	if in.AccessModes != nil {
		in, out := in.AccessModes, &out.AccessModes
		*out = make([]LocalVolumeAccessMode, len(in))
...
func DeepCopy_extensions_LocalVolumeList(in LocalVolumeList, out *LocalVolumeList, c *conversion.Cloner) error {
	if err := unversioned.DeepCopy_unversioned_TypeMeta(in.TypeMeta, &out.TypeMeta, c); err != nil {
		return err
	}
	if err := unversioned.DeepCopy_unversioned_ListMeta(in.ListMeta, &out.ListMeta, c); err != nil {
	...
	if in.Items != nil {
		...
		*out = make([]LocalVolume, len(in))
		for i := range in {
			if err := DeepCopy_extensions_LocalVolume(in[i], &(*out)[i], c); err != nil {
				return err
			}
		}
	} else {
...
func DeepCopy_extensions_LocalVolumeSource(in LocalVolumeSource, out *LocalVolumeSource, c *conversion.Cloner) error {
	out.Path = in.Path
...
func DeepCopy_extensions_LocalVolumeSpec(in LocalVolumeSpec, out *LocalVolumeSpec, c *conversion.Cloner) error {
	if err := DeepCopy_extensions_LocalVolumeSource(in.LocalVolumeSource, &out.LocalVolumeSource, c); err != nil {
		return err
	}
	if in.ClaimRef != nil {
...
func DeepCopy_extensions_LocalVolumeStatus(in LocalVolumeStatus, out *LocalVolumeStatus, c *conversion.Cloner) error {
