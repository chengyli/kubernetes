...
def ensure(name, cidr, ip, mtu=1460):
    '''
    ...
    try:
        cidr_network = IPNetwork(cidr, strict=True)
    except Exception:
    ...
    # # else:
    # #     iptables_rule = None
    #we dont want any iptable rules, yet!
    iptables_rule = None
...
# The following is inlined from  https://github.com/saltstack/salt/blob/2014.7/salt/utils/ipaddr.py
# as the latest version does not seem to have it
