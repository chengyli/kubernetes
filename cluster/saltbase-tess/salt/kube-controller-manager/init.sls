# Ensure we are starting controller manager with a kubeconfig, see kubecfg sls for details
/var/lib/kube-controller/kubeconfig:
    file.managed:
      - source: salt://kubecfg/controller_manager/kubeconfig
      - makedirs: true
      - user: root
      - group: root
      - chmod: 400
